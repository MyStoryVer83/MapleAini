...
public class QuestScriptManager extends AbstractScriptManager {
    ...
    private final static org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(QuestScriptManager.class);
    ...
    public void start(MapleClient c, int questid, int npc) {
        ...
        try {
            ...
            if (iv == null) {
                qm.sendOk("这项任务尚未创建成功：\r\n NpcID: " + npc + "  QuestID: " + questid);
                System.out.println("发现空白任务脚本. (" + questid + ") ");
                qm.dispose();
                return;
            }
            engine.put("qm", qm);
            ...
            log.error("Error executing Quest script. (" + questid + ") " + e);
            dispose(c);
        }
    }
